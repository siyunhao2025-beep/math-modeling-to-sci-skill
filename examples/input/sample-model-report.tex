% COMPATIBILITY ALIAS — retained for the immutable v1.0.0 SKILL.md quick-start path.
% Canonical example for all new documentation/tests: sample-modeling-report.tex
% This compatibility copy is intentionally not a second independent example.
